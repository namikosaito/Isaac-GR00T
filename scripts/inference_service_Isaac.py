...
class ArgsConfig:
    ...
    model_path: str = "/home/namikosaito/work2/Isaac-GR00T/eval/my_gr00t_dataset/checkpoint-1000"
    """Path to the model checkpoint directory."""

    embodiment_tag: Literal[tuple(EMBODIMENT_TAG_MAPPING.keys())] = "new_embodiment"
    """The embodiment tag for the model."""

    data_config: str = "custom_ur10_config:CustomUR10DataConfig"
    """
...
def main(args: ArgsConfig):
    ...
    # Here is mainly a testing code
        ...
        obs = {
            ...
            "state.right_hand": np.random.rand(1, 18),
